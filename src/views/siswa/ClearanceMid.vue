<template>
  <div class="clearance-page" :class="themeClass">
    ...
    <div class="page-hero" :class="themeClass">
      ...
      <h1 class="hero-title">Clearance Slip — MID</h1>
      <p class="hero-subtitle">Status clearance ujian tengah semester (MID).</p>
    ...
    <div class="clearance-layout">
      <main class="clearance-main">
        ...
        <div class="card-status-wrap" :class="themeClass">
          ...
          <div class="status-content">
            <h2 class="status-title">Status Clearance MID</h2>
            <div class="status-badge" :class="statusClass">{{ statusLabel }}</div>
            <p class="status-desc">Status clearance MID Anda akan tampil di sini setelah data tersedia.</p>
          </div>
        </div>
        ...
        <div class="card-detail" :class="themeClass">
          ...
          <div class="detail-grid">
            ...
            <div class="detail-item">
              ...
              <span class="detail-value">Ujian Tengah Semester (MID)</span>
            </div>
            <div class="detail-item">
      ...
      <aside class="clearance-sidebar">
        ...
        <div class="sidebar-card info" :class="themeClass">
          ...
          <ul class="info-list">
            <li>Clearance MID diperlukan untuk mengikuti ujian tengah semester.</li>
            <li>Pastikan semua persyaratan terpenuhi sebelum mengajukan.</li>
