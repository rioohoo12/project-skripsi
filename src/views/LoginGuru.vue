<template>
  <div class="login-page login-guru">
    <div class="login-card">
      ...
      <p class="login-subtitle">SLAPUR System — masuk dengan akun guru</p>
      ...
      <p class="login-footer">
        <router-link to="/guru/buat-akun" class="link">Buat akun</router-link>
        <span class="sep"> · </span>
        <router-link to="/guru/lupa-password" class="link">Lupa password</router-link>
      </p>
    </div>
  </div>
</template>
...
.login-guru .login-btn.guru {
  background: #5b21b6;
}
.login-guru .login-btn.guru:hover:not(:disabled) {
  background: #7c3aed;
}
.login-guru .login-footer .link { color: #5b21b6; }
